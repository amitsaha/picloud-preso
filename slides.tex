...
\usepackage{color} \usepackage{caption}
...
\mode<presentation>  
    { 
      ...
      \begin{frame}{Sanity check}
        ...
        \input{pylang.tex}
        \lstinputlisting[language=Python]{code/sanity.py}
      \end{frame}
      ...
      \begin{frame}{Sorting in the Cloud}
        \input{pylang.tex}
        \lstinputlisting[language=Python]{code/sort.py}
      \end{frame}
      ...
      \begin{frame}{Persistent data demo}
        \input{pylang.tex} \lstinputlisting[language=Python]{code/filedemo.py}
      \end{frame}
      ...
      \begin{frame}{Pyevolve + PiCloud}
        \input{pylang.tex} \lstinputlisting[language=Python]{code/ea.py}
      \end{frame}
      ...
      \begin{frame}{REST API: Publishing a function}
        \input{pylang.tex}
        \lstinputlisting[language=Python]{code/square_rest.py}
      \end{frame}
